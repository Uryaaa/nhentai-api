...
/**
   ...
   * @param {?nHentaiOptions} [options={}] Options to apply.
   */
constructor(options={}){_defineProperty(this,"hosts",void 0),_defineProperty(this,"ssl",void 0),_defineProperty(this,"agent",void 0),_defineProperty(this,"cookies",void 0);let params=function processOptions({hosts:{api:api="nhentai.net",images:images=["i1.nhentai.net","i2.nhentai.net","i3.nhentai.net"],thumbs:thumbs=["t1.nhentai.net","t2.nhentai.net","t3.nhentai.net"]}={},ssl:ssl=!0,agent:agent=null,cookies:cookies=null}={}){agent||(agent=ssl?Agent:Agent$1),"Function"===agent.constructor.name&&(agent=new agent);// Normalize hosts to arrays for consistent handling
